...
class Svg_converter:
    ...
    def convert(self, image_path, svg_path, colors):
        # Load theimage
        ...
        for contour in contours:
            ...
            stroki = random.choice(colors)
            dwg.add(dwg.polyline(points=points, stroke=stroki, fill='none', stroke_width=1))
...
if __name__ == '__main__':
    ...
    Converter.convert("maca.png", "maca.svg", "black, red")
